...
const SecureViewer = {
	...
	openFileViewer: (url, fileName, options = {}) => {
		...
		// URL will have inline disposition set by server
		iframe.src = url;
		...
		// Remove sandbox restrictions to allow PDF viewing
		...
		iframe.onerror = () => {
			clearInterval(progressInterval);
			loadingText.textContent = "Failed to load file";
			loadingText.style.color = "#ef4444";
			spinner.style.display = "none";
			progressBar.style.display = "none";
		};

		// Add no-download overlay for additional security
